...
export const global: globalType = {
    ...
    stageInfo: {
        ...
        costName: ['', 'Энергии', 'Каплей', 'Массы', 'Звёздной пыли', 'Звёздной пыли', 'Тёмной материи'],
        activeAll: [1]
    },
    buildingsInfo: {
    ...
    upgradesInfo: [
        {} as globalType['upgradesInfo'][0], { //Stage 1
            ...
            effectText: [
                ...
                () => `Лужи забустятся в зависимости от каплей ^${format(calculateEffects.S2Upgrade4_power())}.\n(Буст: ${format(calculateEffects.S2Upgrade4(), { padding: true })})`,
